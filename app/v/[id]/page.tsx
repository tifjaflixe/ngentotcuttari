...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://ngentotcuttari.pages.dev/v/${file.file_code}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://ngentotcuttari.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://ngentotcuttari.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://ngentotcuttari.pages.dev/v/${file.file_code}`
            }  
        }
        }
